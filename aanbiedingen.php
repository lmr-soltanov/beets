	...
	<div class="container">
			...
			<div class="row nav-menu text-center">
				<div class="">
					<ul class="nav">
					  	...
					  	<li role="presentation" class="active"><a href="#">Aanbiedingen</a></li>
		...
		<div class="content col-md-19 scrollit">
			...
			<div class="row content-title text-center">
				<h1 style="margin-bottom: 60px;">Aanbiedingen</h1>
			</div>
			<div class="row content-cards">
				<div class="col-md-24 content-card">
					<div class="card-title">
						<p class="text-center">FRESHBED: 1500€ KORTING</p>
					</div>
					<div class="row card-body">
						<div class="col-md-9">
							<img src="images/desktop-promo.gif">
						</div>
						<div class="col-md-15 card-descr">
							<p>Beka Super Promo exclusief bij Beets-Patteet Slaapcomfort! Normale prijs €2499, nu €1799!</p>
							<p>Boxspringset inclusief matras 160x200 of 180x200. Afwerking in leatherlook of stof cat. 2.</p>
							<p>Direct leverbaar!</p>
						</div>
						<button type="button" class="btn btn-primary pull-left btn-consult">Maak een afspraak met onze slaapconsulent</button>
					</div>
				</div>
				<div class="col-md-24 content-card">
					<div class="card-title">
						<p class="text-center">TEMPUR: 2<sup style="font-size: 11pt;">DE</sup> MATRAS 50% KORTING</p>
					</div>
					<div class="row card-body">
						<div class="col-md-9">
							<img src="images/desktop-promo.gif">
