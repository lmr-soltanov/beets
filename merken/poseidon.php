	...
	<div class="container">
				...
				<div class="">
					<ul class="nav">
					  	...
					  	<ul class="sub-menu">
					  		...
					  		<li role="presentation" class="active"><a href="#">Poseidon</a></li>
		...
		<div class="content col-md-19 scrollit">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="<?php echo $site_url; ?>/merken">Merken</a></li>
			...
			<div class="row content-descr text-center">
				<div class="col-md-14 col-md-offset-5">
					<p>
						Ontspannen op water... het lijkt wel een droom. 
						Stelt u zich eens voor: u drijft zo licht als een 
						veertje op een zachte laag van comfortabel warm water 
						dat u zó perfect ondersteunt dat u nauwelijks kunt 
						voelen waar het uw lichaam raakt. En wanneer u beweegt 
						volgt het water direct en geruisloos uw contouren 
						zodat u in iedere houding altijd even comfortabel ligt. 
						Langzaam komt u in een toestand van volledige rust en merkt 
						u dat uw spieren langzaam ontspannen. De stress van de dag 
						glijdt van u af en uw hele lichaam geeft zich over aan een 
						lange, heilzame nachtrust. U bent totaal relaxed en slaapt 
						dieper en beter dan ooit...
					</p>
				</div>
			</div>
			<!-- .content-descr -->
			<div class="row img-links">
				<div class="col-md-8">
					<p class="img-text">Het energiezuinige verwarmings-element staat garant voor een gelijkmatige verdeling van de warmte.</p>
				</div>
				<div class="col-md-16">
